...
class JavascriptParser extends Parser {
	...
	preWalkStatement(statement) {
		function getSourceCode() {
			// @ts-ignore
			const sourceCode = this.state.source;
			const [start, end] = statement.range;
			const statementCode = sourceCode.slice(start, end);
			console.log(
				`Processing statement: ${statementCode};type:${statement.type}`
			);
		}
		// getSourceCode.call(this);
		/** @type {StatementPath} */
